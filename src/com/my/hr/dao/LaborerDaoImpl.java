...
public class LaborerDaoImpl implements LaborerDao {
	...
	@Override
	public void updateLaborerName(int laborerId, String laborerName) {
		laborerMap.updateLaborerName(laborerId, laborerName);
	}
	
	@Override
	public void updateLaborerDate(int laborerId, LocalDate hireDate) {
		laborerMap.updateLaborerDate(laborerId, hireDate);
	}
